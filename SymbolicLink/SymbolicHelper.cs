...
{
    public static class SymbolicHelper
    {
        #region Flags
        ...
        /// <summary>
        /// Creates a junction point file by CreateSymbolicLink
        /// </summary>
        /// <param name="source"></param>
        /// <param name="target"></param>
        public static void CreateFile(string source, string target)
        {
            CreateSymbolicLink(source, target, SymbolicLink.File);
        }

        /// <summary>
        /// Creates a junction point directory by CreateSymbolicLink
        /// </summary>
        /// <param name="source"></param>
        /// <param name="target"></param>
        public static void CreateDirectory(string source, string target)
        {
            CreateSymbolicLink(source, target, SymbolicLink.Directory);
        }
